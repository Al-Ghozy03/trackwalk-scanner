...
class FluffyValue {
  ...
  factory FluffyValue.fromJson(Map<String, dynamic> json) => FluffyValue(
        ...
        gateways: Map.from(json["gateways"])
            .map((k, v) => MapEntry<String, Gateway>(k, Gateway.fromJson(v))),
      );

  Map<String, dynamic> toJson() => {
        "enable_prod": enableProd,
        "gateways": Map.from(gateways)
...
class Gateway {
  ...
  factory Gateway.fromJson(Map<String, dynamic> json) => Gateway(
        ...
        outputtextWpml:
            List<dynamic>.from(json["outputtext_wpml"].map((x) => x)),
      );
