...
//     List<String> wooCommerceEventsBookingOptionIDs;
//     Map<String, WooCommerceEventsBookingOption> wooCommerceEventsBookingOptions;
...
//         wooCommerceEventsTicketHeaderImage: json["WooCommerceEventsTicketHeaderImage"],
//         wooCommerceEventsLocation: json["WooCommerceEventsLocation"],
//         wooCommerceEventsSupportContact: json["WooCommerceEventsSupportContact"],
...
//         wooCommerceEventsBackgroundColor: json["WooCommerceEventsBackgroundColor"],
//         wooCommerceEventsTextColor: json["WooCommerceEventsTextColor"],
//         wooCommerceEventsBookingsBookingDetailsOverride: json["WooCommerceEventsBookingsBookingDetailsOverride"],
//         wooCommerceEventsBookingsBookingDetailsOverridePlural: json["WooCommerceEventsBookingsBookingDetailsOverridePlural"],
//         wooCommerceEventsBookingsSlotOverride: json["WooCommerceEventsBookingsSlotOverride"],
//         wooCommerceEventsBookingsSlotOverridePlural: json["WooCommerceEventsBookingsSlotOverridePlural"],
//         wooCommerceEventsBookingsDateOverride: json["WooCommerceEventsBookingsDateOverride"],
//         wooCommerceEventsBookingsDateOverridePlural: json["WooCommerceEventsBookingsDateOverridePlural"],
//         wooCommerceEventsType: json["WooCommerceEventsType"],
//         wooCommerceEventsBookingOptionIDs: json["WooCommerceEventsBookingOptionIDs"] == null ? null : List<String>.from(json["WooCommerceEventsBookingOptionIDs"].map((x) => x)),
//         wooCommerceEventsBookingOptions: json["WooCommerceEventsBookingOptions"] == null ? null : Map.from(json["WooCommerceEventsBookingOptions"]).map((k, v) => MapEntry<String, WooCommerceEventsBookingOption>(k, WooCommerceEventsBookingOption.fromJson(v))),
//         wooCommerceEventsEndDate: json["WooCommerceEventsEndDate"] == null ? null : json["WooCommerceEventsEndDate"],
//         wooCommerceEventsEndDateFull: json["WooCommerceEventsEndDateFull"] == null ? null : json["WooCommerceEventsEndDateFull"],
//         wooCommerceEventsEndDateTimestamp: json["WooCommerceEventsEndDateTimestamp"] == null ? null : json["WooCommerceEventsEndDateTimestamp"],
//         wooCommerceEventsEndDateDay: json["WooCommerceEventsEndDateDay"] == null ? null : json["WooCommerceEventsEndDateDay"],
//         wooCommerceEventsEndDateMonth: json["WooCommerceEventsEndDateMonth"] == null ? null : json["WooCommerceEventsEndDateMonth"],
//         wooCommerceEventsEndDateYear: json["WooCommerceEventsEndDateYear"] == null ? null : json["WooCommerceEventsEndDateYear"],
//     );
...
//         "WooCommerceEventsTicketHeaderImage": wooCommerceEventsTicketHeaderImage,
...
//         "WooCommerceEventsBookingsBookingDetailsOverride": wooCommerceEventsBookingsBookingDetailsOverride,
//         "WooCommerceEventsBookingsBookingDetailsOverridePlural": wooCommerceEventsBookingsBookingDetailsOverridePlural,
//         "WooCommerceEventsBookingsSlotOverride": wooCommerceEventsBookingsSlotOverride,
//         "WooCommerceEventsBookingsSlotOverridePlural": wooCommerceEventsBookingsSlotOverridePlural,
//         "WooCommerceEventsBookingsDateOverride": wooCommerceEventsBookingsDateOverride,
//         "WooCommerceEventsBookingsDateOverridePlural": wooCommerceEventsBookingsDateOverridePlural,
//         "WooCommerceEventsType": wooCommerceEventsType,
//         "WooCommerceEventsBookingOptionIDs": wooCommerceEventsBookingOptionIDs == null ? null : List<dynamic>.from(wooCommerceEventsBookingOptionIDs.map((x) => x)),
//         "WooCommerceEventsBookingOptions": wooCommerceEventsBookingOptions == null ? null : Map.from(wooCommerceEventsBookingOptions).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
//         "WooCommerceEventsEndDate": wooCommerceEventsEndDate == null ? null : wooCommerceEventsEndDate,
//         "WooCommerceEventsEndDateFull": wooCommerceEventsEndDateFull == null ? null : wooCommerceEventsEndDateFull,
//         "WooCommerceEventsEndDateTimestamp": wooCommerceEventsEndDateTimestamp == null ? null : wooCommerceEventsEndDateTimestamp,
//         "WooCommerceEventsEndDateDay": wooCommerceEventsEndDateDay == null ? null : wooCommerceEventsEndDateDay,
//         "WooCommerceEventsEndDateMonth": wooCommerceEventsEndDateMonth == null ? null : wooCommerceEventsEndDateMonth,
//         "WooCommerceEventsEndDateYear": wooCommerceEventsEndDateYear == null ? null : wooCommerceEventsEndDateYear,
//     };
// }
...
//     factory WooCommerceEventsBookingOption.fromJson(Map<String, dynamic> json) => WooCommerceEventsBookingOption(
//         label: json["label"],
//         addDate: Map.from(json["add_date"]).map((k, v) => MapEntry<String, AddDate>(k, AddDate.fromJson(v))),
//         addDateIds: List<String>.from(json["add_date_ids"].map((x) => x)),
//     );

//     Map<String, dynamic> toJson() => {
//         "label": label,
//         "add_date": Map.from(addDate).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
