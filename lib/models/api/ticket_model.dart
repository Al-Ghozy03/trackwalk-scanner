...
class TicketModel {
  ...
  factory TicketModel.fromJson(Map<String, dynamic> json) => TicketModel(
        ...
        number: json["number"],
        metaData: List<TicketModelMetaDatum>.from(
            json["meta_data"].map((x) => TicketModelMetaDatum.fromJson(x))),
        ...
        feeLines: List<FeeLine>.from(
            json["fee_lines"].map((x) => FeeLine.fromJson(x))),
...
class FeeLine {
  ...
  factory FeeLine.fromJson(Map<String, dynamic> json) => FeeLine(
        ...
        metaData: List<FeeLineMetaDatum>.from(
            json["meta_data"].map((x) => FeeLineMetaDatum.fromJson(x))),
      );
...
class FeeLineMetaDatum {
  ...
  factory FeeLineMetaDatum.fromJson(Map<String, dynamic> json) =>
      FeeLineMetaDatum(
        id: json["id"],
        key: json["key"],
        value: json["value"],
...
class TicketModelMetaDatum {
  ...
  factory TicketModelMetaDatum.fromJson(Map<String, dynamic> json) =>
      TicketModelMetaDatum(
        id: json["id"],
        key: json["key"],
        value: json["value"],
...
class ValueClass {
  ...
  factory ValueClass.fromJson(Map<String, dynamic> json) => ValueClass(
        the1: json["1"] == null
            ? null
            : Map.from(json["1"])
                .map((k, v) => MapEntry<String, The1>(k, The1.fromJson(v))),
        ...
        recalcFeeSaveOrder: json["recalc_fee_save_order"] == null
            ? null
            : json["recalc_fee_save_order"],
        fixedGateway:
            json["fixed_gateway"] == null ? null : json["fixed_gateway"],
        feeItems: json["fee_items"] == null
            ? null
            : List<dynamic>.from(json["fee_items"].map((x) => x)),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "recalc_fee_save_order":
            recalcFeeSaveOrder == null ? null : recalcFeeSaveOrder,
        "fixed_gateway": fixedGateway == null ? null : fixedGateway,
        "fee_items": feeItems == null
            ? null
            : List<dynamic>.from(feeItems!.map((x) => x)),
...
class The1 {
  ...
  factory The1.fromJson(Map<String, dynamic> json) => The1(
        ...
        wooCommerceEventsPurchaserFirstName:
            json["WooCommerceEventsPurchaserFirstName"],
        wooCommerceEventsPurchaserLastName:
            json["WooCommerceEventsPurchaserLastName"],
        wooCommerceEventsPurchaserEmail:
            json["WooCommerceEventsPurchaserEmail"],
        wooCommerceEventsPurchaserPhone:
            json["WooCommerceEventsPurchaserPhone"],
        wooCommerceEventsCustomAttendeeFields:
            json["WooCommerceEventsCustomAttendeeFields"],
        ...
        wooCommerceEventsBookingOptions:
            json["WooCommerceEventsBookingOptions"] == null
                ? null
                : WooCommerceEventsBookingOptions.fromJson(
                    json["WooCommerceEventsBookingOptions"]),
      );
  ...
  Map<String, dynamic> toJson() => {
        ...
        "WooCommerceEventsBookingOptions":
            wooCommerceEventsBookingOptions == null
                ? null
                : wooCommerceEventsBookingOptions!.toJson(),
      };
}
...
class WooCommerceEventsBookingOptions {
  ...
  factory WooCommerceEventsBookingOptions.fromJson(Map<String, dynamic> json) =>
      WooCommerceEventsBookingOptions(
        slot: json["slot"],
